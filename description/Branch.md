...
--------
*   Reset <br>
reset will delete the commits <br>
...
*   Checkout <br>
checkout just move HEAD to another pointer, but you must create new branch name on original commit otherwise you will not reach the original commit again. <br>
&ensp; &ensp; &ensp; clean the staged file: `git reset HEAD` <br>
